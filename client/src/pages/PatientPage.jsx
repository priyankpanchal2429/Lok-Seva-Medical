        ...
        <table className="si-table">
          <thead>
            <tr>
              ...
              <th className="si-th" style={{ width: '100px', textAlign: 'center' }}>Actions</th>
            </tr>
          </thead>
          <tbody>
            {loading ? (
              <tr>
                <td colSpan="6" className="si-empty-row">Loading patients...</td>
              </tr>
            ) : filteredPatients.length === 0 ? (
              <tr>
                <td colSpan="6" className="si-empty-row">No patients found.</td>
              </tr>
            ) : (
                ...
                <tr key={patient._id} className="si-table-row">
                  ...
                  <td className="si-td">
                    <div style={{ display: 'flex', gap: '8px', justifyContent: 'center' }}>
                      <button className="pt-icon-btn pt-edit" onClick={() => handleEditClick(patient)} title="Edit">
                        <EditIcon />
                      </button>
                      <button className="pt-icon-btn pt-delete" onClick={() => handleDelete(patient._id)} title="Delete">
                        <TrashIcon />
                      </button>
                    </div>
                  </td>
